...
function initialize() {
    var mapOptions = {
      zoom: 14,
      center: new google.maps.LatLng(38.6237471,27.387826)
    };
...
var script = document.createElement('script');
    ...
    script.src = 'https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyBJn0A0vNrnnf7WDuxOToBzAnBtcxCy368&sensor=false&' +
        'callback=initialize';
